    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{background: "hsl(var(--surface))"}}>
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        <form onSubmit={verify} className="space-y-4">
          <input value={code} onChange={e=>setCode(e.target.value.replace(/\D/g,"").slice(0,6))} maxLength={6} inputMode="numeric" required placeholder="000000" className="input text-center text-3xl font-bold tracking-[0.5em]" autoFocus autoComplete="one-time-code"/>
