...
export default function RegisterPage() {
  ...
  const selStyle = { background: "hsl(var(--input))", border: "1px solid hsl(var(--border))", color: "hsl(var(--foreground))", appearance: "auto" as const }
  const label = "block text-xs mb-1.5"
  const labelStyle = { color: "hsl(var(--muted-foreground))" }

  return (
    <div className="min-h-screen flex items-start justify-center px-4 py-16" style={{ background: "hsl(var(--background))" }}>
      <div className="w-full max-w-lg space-y-8">
        <div>
          <div className="text-sm mb-6" style={{ color: "hsl(var(--muted-foreground))" }}>Alcazar Capital</div>
        ...
        <form onSubmit={submit} className="space-y-8">
          ...
          <section className="space-y-4">
            <h3 className="text-xs font-medium uppercase tracking-widest" style={{ color: "hsl(var(--muted-foreground))" }}>Account</h3>
          ...
          <section className="space-y-4 border-t pt-6" style={{ borderColor: "hsl(var(--border))" }}>
            <h3 className="text-xs font-medium uppercase tracking-widest" style={{ color: "hsl(var(--muted-foreground))" }}>Personal</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
          ...
          {/* Professional */}
          <section className="space-y-4 border-t pt-6" style={{ borderColor: "hsl(var(--border))" }}>
            <h3 className="text-xs font-medium uppercase tracking-widest" style={{ color: "hsl(var(--muted-foreground))" }}>Professional</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
          ...
          <button type="submit" disabled={loading} className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-medium transition-opacity" style={{ background: "hsl(var(--foreground))", color: "hsl(var(--background))", opacity: loading ? 0.7 : 1 }}>
        ...
        <p className="text-sm text-center" style={{ color: "hsl(var(--muted-foreground))" }}>
          ...
          <Link href="/" style={{ color: "hsl(var(--foreground))", textDecoration: "underline" }}>Sign in</Link>
        </p>
      </div>
    </div>
  )
